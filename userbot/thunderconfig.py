...
class Config(object):
    ...
    NO_OF_COLOUMS_DISPLAYED_IN_H_ME_CMD = int(
        os.environ.get("NO_OF_COLOUMS_DISPLAYED_IN_H_ME_CMD", 8)
    )
    ...
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://telegra.ph/file/ed2b104b8a75ac058c097.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/ed2b104b8a75ac058c097.jpg"
    )
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/ed2b104b8a75ac058c097.jpg",
    )
