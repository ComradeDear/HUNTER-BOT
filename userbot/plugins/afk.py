    ...
    if ".afk" not in current_message and "yes" in USER_AFK:  # pylint:disable=E0602
        ...
        try:
            ...
            await borg.send_message(  # pylint:disable=E0602
                ...
                + "Ask In @hunterbot_support Chat grp to get help..\n\n `{}`".format(
                    str(e)
                ),
...
@borg.on(hunter_cmd(pattern=r"afk ?(.*)", outgoing=True))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    global USER_AFK  # pylint:disable=E0602
