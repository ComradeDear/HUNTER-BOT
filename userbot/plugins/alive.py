...
from userbot.utils import hunter_cmd, edit_or_reply, sudo_cmd
...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/ed2b104b8a75ac058c097.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/ed2b104b8a75ac058c097.jpg"
else:
    CAT_IMG = CAT_IMGE
...
@borg.on(hunter_cmd(outgoing=True, pattern="salive"))
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        ...
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/hunterbot_channel)\n"
        )
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/hunterbot_support)\n"
        )
        pm_caption += "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://jenaatul8.wixsite.com/hellboi-atul)\n"
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ HUNTERBOT ](https://t.me/hunterbot_support)\n"
        pm_caption += "[┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/hunterbot_support)"
        ...
        return
    req = requests.get("https://telegra.ph/file/ed2b104b8a75ac058c097.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ HUNTERBOT ](https://t.me/hunterbot_support)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/hunterbot_support)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥HUNTERBOT ɨs օռʟɨռɛ🔥🔥**__\n\n"
...
pm_caption += f"😈HUNTERBOT😈       : __**{hellversion}**__\n"

pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/hunterbot_channel)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/krish1303y)\n\n"

pm_caption += "    [✨REPO✨](https://github.com/ComradeDear/HUNTERBOT) 🔹 [📜License📜](https://github.com/ComradeDear/HUNTERBOT/blob/master/LICENSE)"


@borg.on(hunter_cmd(outgoing=True, pattern="halive$"))
...
@borg.on(hunter_cmd(outgoing=True, pattern="calive$"))
...
async def amireallyalive(calive):
    ...
    if PM_IMG:
        ...
        pm_caption += f"**{EMOJI} HUNTERBOT Userbot Version :** `{catversion}`\n"
