...
#Import Gudz
RUN wget https://raw.githubusercontent.com/ComradeDear/HUNTERBOT/master/hunterbotrun.py
RUN wget https://raw.githubusercontent.com/ComradeDear/HUNTERBOT/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","hunterbotrun.py"]
