...
class Var(object):
    ...
    # 6 is a placeholder
    HUNTER_PRO = os.environ.get("HUNTER_PRO", None)
    if not HUNTER_PRO:
        HUNTER_PRO = "YES"
    else:
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/ComradeDear/HUNTERBOT"
    )
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://telegra.ph/file/86eef28dac34c7297c1a4.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/86eef28dac34c7297c1a4.jpg"
    )
    ALIVE_IMAGE = os.environ.get(
        "ALIVE_PIC", "https://telegra.ph/file/86eef28dac34c7297c1a4.jpg"
    )
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/86eef28dac34c7297c1a4.jpg",
    )
